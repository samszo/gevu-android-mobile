...
public class TreeItemRenderer extends ItemRenderer implements ITreeItemRenderer
{
	...
	protected var _disclosureIcon:Class;
	...
	{
//trace("TreeItemRenderer.disclosureIconVisible, isBranch? "+isBranch+", hasChildren? "+hasChildren);		
	...
	{
		children = data ? (data as TreeItem).childrens : null;
	}
